            ...
            <div class="w-full px-6 py-8 md:p-8">
                ...
                <form class="mt-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input wire:model.live='CVV' class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="cvv" type="text" placeholder="***">
                        @error('CVV')
                        <div class="bg-red-500 text-black">{{ $message }}</div>
                        @enderror
                    </div>
                    <button wire:click="CheckOut" class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                        Submit
                    </button>
                </form>
            </div>
