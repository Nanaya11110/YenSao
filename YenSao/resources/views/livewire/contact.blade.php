...
<section class="text-gray-600 body-font relative">
    ...
    rounded shadow-lg hidden">
        <p class="font-bold">Gửi Email thành công</p>
    ...
    <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div
            ...
            <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                ...
                <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                    ...
                    <a class="text-green-500 leading-relaxed">DTVietnam@gmail.com</a>
        ...
        <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <button wire:click='SendEmail'
                class="text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg">Gửi</button>
            <p class="text-xs text-gray-500 mt-3">Cảm ơn bạn đã liên lạc.</p>
            <p wire:loading>Sending...</p>
        </div>
    </div>
</section>
<script>
